...
local font_stack = { "mainmenu.title.small2" }
local curtag = nil
local blocks = {}
...
--[[---------------------------------------------------------
   ...
   Usage: ml:GetHeight()
-----------------------------------------------------------]]
function ChatObject:GetHeight()
	return self.totalHeight
end

--[[---------------------------------------------------------
-----------------------------------------------------------]]
function ChatObject:Size()
...
-----------------------------------------------------------]]
function ChatObject:Draw(xOffset, yOffset, halign, valign, alphaoverride)
...
-----------------------------------------------------------]]
function ParseMessage(ml, maxwidth)
	
	colour_stack = { {r=255,g=255,b=255,a=255} }
	font_stack = { "chatbox.font" }
	blocks = {}
	...
	local newObject = ChatObject:Create()	
